...
async function createInvoicePDFWithPdfKit(order, outputPath) {
    ...
    // Customer Info
    doc.fontSize(17).text('Customer Information', { underline: true, lineGap: 20 });
    const info = [
    ...
    const table = {
        headers: [
            {
                label: 'Image', property: 'image', width: 70,
                renderer: (value, indexColumn, indexRow, row, rectRow, rectCell) => {
                    const { x, y, width, height } = rectCell;
                    console.log('rectCellrectCellrectCellrectCellrectCellrectCell', rectCell);
    ...
    doc.fontSize(12).text(`$${order.paidTotal}`, startX + labelWidth, total_paid_y_pos);
    ...
    const html = `
        ...
        <body>
          ...
          <div class="section">
            ...
            <div class="info-grid">
              <div>Full name:</div><div>${order.firstName}&nbsp;${order.lastName}</div>
          ...
          <div class="section">
            ...
            <div class="info-grid">
              ...
              <div class="bt">Total Order:</div><div class="bt">${order.paidTotal.toFixed(2)}</div>
            </div>
          </div>
        </body>
        </html>
