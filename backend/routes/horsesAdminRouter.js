...
router.get('/:weekId/horseimages-for-candid-award', controller.getUnprocessedImagesForCandidAward);
...
router.post('/:weekId/horses/mark-images-as-processed-for-candid-award-check', controller.markImagesAsProcessedForCandidAwardCheck);
